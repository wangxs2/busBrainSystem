      ...
      <div class="tablbox">
        ...
        >
          ...
          <div
            :style="{
              color:
                (item.congestIndex > 1 && item.congestIndex < 1.5) ||
                item.congestIndex == 1
                  ? 'rgb(22, 206, 149)'
                  : (item.congestIndex < 1.8 && item.congestIndex > 1.5) ||
                    item.congestIndex == 1.5
                  ? 'rgb(247, 157, 6)'
                  : (item.congestIndex < 2 && item.congestIndex > 1.8) ||
                    item.congestIndex == 1.8
                  ? 'rgb(216, 3, 4)'
                  : 'rgb(143, 0, 33)',
            }"
          >
...
.roadDistribution-box {
  ...
  .green_marker {
    box-shadow: 0 0 0 3px rgb(22 206 149 / 75%),
      0px 0 0 6px rgb(22 206 149 / 58%);
  }
  .yellow_marker {
