<template>
  <div class="repetitionRactor" id="repetit">
     <div class="search-box">

      <div style="margin-right:0.6vw;margin-left:0.1vw;width:3.5vw;">线路名称</div>
      <el-select style="width:40%" size="small" clearable filterable @change="getDetail" v-model="value" placeholder="请选择">
        <el-option
