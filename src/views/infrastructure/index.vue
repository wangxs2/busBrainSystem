<template>
  <div class="infrastructure" id="infrastruc">
    ...
    <el-dialog
      ...
      <!-- 场站和枢纽站的列表 -->
      <div class="mybix" v-show="nowName=='场站'||nowName=='枢纽站'">
        <div class="ecgbox">
      ...
      <!--  首末站数据列表-->
      <!--  途径站数据列表-->
      <div class="mybix" v-show="nowName=='途径站'">
         <div class="ecgbox">
...
export default {
  ...
  methods:{
    ...
    maplocalMain(datapoint){
      ...
      let _events = datapoint;
        var list = _events.map(e => {
            let arr =(this.nowName=='场站'||this.nowName=='枢纽站')?[e.longitude,e.latitude]:[e.lng,e.lat]
            return {
                "type": "Feature",
                "properties": {
                    rawData: e
