  ...
  <div class="roadDistribution-box" id="lineIndex" v-loading="assloading"
    ...
    <div class="rightlinemsg" >
       <div class="tit">上南路轨交基本情况</div>
        <div>
           <p> （1）上南路客运走廊与5条轨道交通线路相交：轨道交通 6号线、7号线、8号线、11号线、13号线；</p>
           <p> （2）上南路博成路、上南路浦东南路、上南路德州路、上南路华夏西路4个公交站点与轨道交通站点相接驳；</p>
           <p> （3）沿线轨道站点5个(中华艺术宫、耀华路、成山路、上南路、三林)；</p>
           <p> （4）6号线联系浦东塘桥、陆家嘴等区域；</p>
           <p> （5）7号线联系浦西、浦东北蔡、花木地区；</p>
            <p>（6）8号线联系浦西；</p>
            <p>（7）11号线联系浦西、浦东康桥镇、迪士尼；</p>
            <p>（8）13号线联系浦西、浦东北蔡、张江。</p>
        </div>
      ...
      <div class="tablbox">
        <div  class="bttit bttit1" @click="toDetail1(item)" v-for="(item,index) in mgdata" :key="index">
          <div>{{item.name}}</div>
          <div>{{item.styion}}</div>
