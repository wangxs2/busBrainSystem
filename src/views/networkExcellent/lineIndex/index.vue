  ...
  <div class="roadDistribution-box" id="lineIndex" v-loading="assloading"
    ...
    <div class="rightlinemsg">
      ...
      <div class="bttit">
        <div>序号</div>
        <div>线路名称</div>
        <div style="position:relative">非直线系数 <img class="sxactive" @click="sottable('非直线系数','sx')"  width="18" height="18" src="../../../assets/image/sx.png"/>    <img  class="sxactive1" @click="sottable('非直线系数','jx')" width="18" height="18" src="../../../assets/image/jx.png"/>   </div>
        <div style="position:relative">线路总长(km) <img @click="sottable('线路总长','sx')" class="sxactive" width="18" height="18" src="../../../assets/image/sx.png"/>    <img  @click="sottable('线路总长','jx')"  class="sxactive1" width="18" height="18" src="../../../assets/image/jx.png"/>  </div>
        <div style="position:relative">路径上长度(km) <img @click="sottable('路径上长度','sx')" class="sxactive" width="18" height="18" src="../../../assets/image/sx.png"/>    <img  @click="sottable('路径上长度','jx')"  class="sxactive1" width="18" height="18" src="../../../assets/image/jx.png"/> </div>
        <div>站点数</div>
        <div>路径上站点数</div>
        <div style="position:relative">站点占比 <img @click="sottable('站点占比','sx')" class="sxactive" width="18" height="18" src="../../../assets/image/sx.png"/>    <img  @click="sottable('站点占比','jx')"  class="sxactive1" width="18" height="18" src="../../../assets/image/jx.png"/></div>
        <div>配车数</div>
        <div>全天客流</div>
        <div>上南路相关客流</div>
        <div>百公里人次</div>
      ...
      <div class="tablbox">
        <div  :class="nowindex==n?'bttit bttit1 bttit2':'bttit bttit1'" @click="toDetail(item,n)" v-for="(item,n) in linewData1" :key="n">
 ...
 position:relative;
  ...
  .rightlinemsg1{
   ...
   .rightlinemsg{
    ...
    //  overflow: hidden;
      overflow: scroll;
    .sxactive{position:absolute;right:-12px;top:14px;cursor:pointer}
    .sxactive:active{
      top:16px
    }
    .sxactive1{position:absolute;right:-12px;top:28px;cursor:pointer}
    .sxactive1:active{
      top:30px
    }
    .tit {
