  ...
  >
    <div class="rightlinemsg">
      ...
      <div style="box-sizing: border-box; padding: 0 1.2vw">
        ...
        <p>
          （2）全天客流共计88497人次，其中到发客流占比最高，为51534人次，占比58.2%，过境客流为27995人次，占比31.6%；
        </p>
        <p>
          （3）上南路上客流分配占比最高的线路为576路(15.4%) 与周南线(12.9%)。
        </p>
      </div>
      ...
      <div style="box-sizing: border-box; padding: 1.2vh 1.2vw">
        上南路到发客流量占总体客流量的50%以上，属于到发型客运走廊。
      </div>
    </div>
